...
# Gunakan daftar pasaran yang lebih lengkap sebagai default
try:
...
with tab_manajemen:
    ...
    st.info("Latih, hapus, atau perbarui model AI Anda di sini.")
    # ... Logika manajemen ...

with tab_scan:
    st.subheader("Pencarian Window Size (WS) Optimal")
    st.info("Fitur ini sedang dalam perbaikan untuk stabilitas. Silakan atur WS secara manual di sidebar.")
